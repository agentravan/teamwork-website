...
export const metadata: Metadata = {
  title: 'TeamWork Solutions - Global HR & Payroll OS',
  description: 'The Operating System for Modern Teams. Automate payroll, compliance, and HR operations worldwide.',
};
